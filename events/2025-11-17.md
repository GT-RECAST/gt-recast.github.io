...
**Restauration:** Nous fournirons les pauses café mais pas le déjeuner. Les alentours de l’ENS regorgent d’options pour se restaurer. Vous trouverez en particulier trois zones :

 — la plus proche : rue Claude Bernard/rue Berthollet (en bas sur la carte : italien, brasserie, sushi…)

 — la plus connue : rue Mouffetard/rue du Pot de Fer (à droite sur la carte : brasserie, crêperie, tartes, sandwiches libanais…)

 — en direction du jardin du Luxembourg: rue Saint-Jacques, rue des Fosses Saint-Jacques (à gauche sur la carte : asiatique, italien, poke, sandwiches,… ) 
 
<img src="restauration-ens-881x1024.png" alt="plan-restauration" width="800"/>
